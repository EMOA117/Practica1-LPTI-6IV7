...
public class MainActivity extends AppCompatActivity {
    ...
    public void promedio(View view){
        ...
        String resultmat1 = String.valueOf(Math.round(promediomat1));
        String resultmat2 = String.valueOf(Math.round(promediomat2));
        String resultmat3 = String.valueOf(Math.round(promediomat3));
        String resultmat4 = String.valueOf(Math.round(promediomat4));
        String resultmat5 = String.valueOf(Math.round(promediomat5));
        String resultmat6 = String.valueOf(Math.round(promediomat6));
        String resultmat7 = String.valueOf(Math.round(promediomat7));
        String resultmat8 = String.valueOf(Math.round(promediomat8));
        String resultmat9 = String.valueOf(Math.round(promediomat9));
        String resultmat10 = String.valueOf(Math.round(promediomat10));


        String result = String.valueOf(Math.round(promedio1par));
        String resultpar2 = String.valueOf(Math.round(promedio2par));
